...
CFLAGS = ["--std=c89", "-Wall", "-Wextra", "-D_DIAB_TOOL", "-DAST_ARCH_E500"]

COMP_SUMMARY_JSON = Path(
        'bundle/compilation_summary_power-qoriq-p1011-ganav800-p.json')

SOURCE_COMP_SUMMARY_JSON = Path(
        'source_bundle/source_compilation_summary.json')
